...
class PledgesController extends Controller
{
    public function index(Request $request)
    {
        $pledges = [
	        ...
	        ["file" => "ArditaXhemajli.png", "name" => "Ardita Xhemajli"],
	        ["file" => "ArtaIbishiCitaku.png", "name" => "Arta Ibishi Citaku"],
            ["file" => "BarrieFreeman.png", "name" => "Barrie Freeman"],
            ["file" => "BDG.png", "name" => "BDG"],	
	        ["file" => "BTB.png", "name" => "BTB"],	
            ...
            ["file" => "DaniloDjuric.png", "name" => "Danilo Duric"],
	        ...
	        ["file" => "ErnaSalihu.png", "name" => "Erna Salihu"],
	        ...
	        ["file" => "MarijaStanojkovic.png" , "name" => "Marija Stanojkovic"],
