...
?>
        ...
        <div class="c-sidebar-brand">
            <img class="c-sidebar-brand-full" src="{{ url('frontend/images/kosovo-logo-en.png') }}" width="118" height="46" alt="CoreUI Logo">
            <img class="c-sidebar-brand-minimized" src="{{ url('frontend/images/kosovo-logo-en.png') }}" width="118" height="46" alt="CoreUI Logo">
        </div>
