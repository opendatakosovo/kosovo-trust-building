                ...
                <div class="col-md-12">
                    <div class="page-title-heading v1">
                        <div class="page-title-heading">
                            ...
                            <h1 class="title">Benjamin Ibrahimi: Life is like a dance!</h1>
                    ...
                    <article class="blog-post">
                        <div class="content-blog-post">
                            <h2 class="title-blog-post">
                                ...
                                <a href="#">Benjamin Ibrahimi: Life is like a dance!</a>
                    ...
                    <nav class="navigation posts-navigation" role="navigation">
                        ...
                        <div class="nav-links clearfix">
                            <div class="nav-previous">
                                <a href="/en/music-story" rel="prev">Prev Post</a>
                            </div>
                            <div class="nav-next">
                                <a href="/en/education-story" rel="next">Next post</a>
                            </div>
                        </div><!-- .nav-links -->
                    </nav>
