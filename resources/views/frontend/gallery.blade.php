...
<head>
    ...
    <!-- Revslider -->
    <link rel='stylesheet' href='stylesheets/settings.css?rev=4.6.5' type='text/css' media='all' />
            ...
            <div class="container">
                <div class="row">
                    <ul class="portfolio-filter">
                        ...
                        <li><a data-filter=".inter" href="#">International Mother Language Event</a></li>
                        <li><a data-filter=".cso" href="#">CSO Dialogue Forum</a></li>
                        <li><a data-filter=".ktbforum" href="#">Kosovo Trust-Building Forum</a></li>
                        <li><a data-filter=".adapt" href="#">Adaptation of Municipalities</a></li>
                        <li><a data-filter=".munic" href="#">E-Municipalities Forum</a></li>
                    ...
                    <div class="bond-portfolio three_columns">
                        <div class="portfolio-container clearfix no-margin one-four ">
                            ...
                            <div class="item builder ktbforum">
                                <div class="featured-post">
                                    <a class="popup-gallery" href="#">
                                        <div class="overlay">
                                            <div class="link">
                    ...
                    <a class="box-readmore center-rx" href="https://www.flickr.com/photos/185701275@N02/albums">VIEW GALLERY IN FLICKR</a>
