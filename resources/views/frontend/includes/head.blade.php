 ...
 <meta charset="utf-8">
    ...
    <!-- Animation Style -->
    <link href="{{ asset('frontend/stylesheets/animate.css') }}" rel="stylesheet">
    <link href="{{ asset('frontend/stylesheets/swiper.min.css') }}" rel="stylesheet">
    ...
    <script src="{{ asset('https://maps.googleapis.com/maps/api/js?key=AIzaSyBvV0EE3yFozGhjmUv3BgoyviVdXzCwHlk') }}"></script>
