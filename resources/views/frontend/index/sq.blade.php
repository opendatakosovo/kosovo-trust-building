  ...
  $(".changeLang").change(function(){
    ...
    <section class="bond-row ab3-s1 padb-134">
        <div class="title-section style2">
            <h3 class="title">Mirë se erdhët</h3>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="title-section style1">
                        <h3 class="title">Mirë se erdhët në Platformen e Ndërtimit të Besimit të Kosovës</h3>
                ...
                <div class="col-md-6 padl-44 magt--10">
                    <div class="flat-box-content">
                        <h4 class="sub-title">Rreth nesh</h4>
                        <h2 class="title">Kush jemi ne</h2>
                        <div class="content">
                            <p>Në maj 2018, me mbështetjen e UNKT, UNMIK mblodhi 120 pjesëmarrës që përfaqësonin një sektor të gjerë të shoqërisë kosovare, përfshirë aktorët bazë, mediat, udhëheqësit e të rinjve dhe udhëheqja komunale nga komunitetet shumicë dhe jo-shumicë, për të shkëmbyer perspektiva në ndërtimin e besimit .</p>
                            <br><br>
                            <p>
    ...
    <section class="padb-49">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <br><br><br>
                    <h2 class="title" style="text-align: center;">Si po e arrijmë</h2><br><br>
                        <div class="row pt-3">
            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-1">
                    <div class="flat-box-content padl-30">
                        <h1 class="title" style="color:white">Si mund të kontriboni</h1>
                        <h2 class="sub-title">Bëni ndryshime të mëdha duke filluar nga të voglat</h2>
                        <p style="color: white;">Lista e plotë e rekomandimeve dhe raporti përfundimtar janë në dispozicion në gjuhën angleze, shqipe dhe serbe. Kjo platformë është një vazhdim i diskutimeve të Forumit mbi veprimet e nevojshme për të ndërtuar një shoqëri më paqësore dhe gjithëpërfshirëse dhe kërkon të promovojë iniciativat dhe përpjekjet bazë dhe të shoqërisë civile nga organizatat ndërkombëtare, si dhe politikat dhe veprimet institucionale për avancimin e ndërtimit të besimit në Kosovë.</p>
                        <a class="flat-button" href="/trustbuildingnetworkk">Shiqoni më shumë</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row " data-item="4" data-nav="true" data-dots="false" data-auto="false" data-margin="30">
                <div class="item col-md-4 col-xs-6 pad-0_40">
                    <div class="bond-iconbox square outtop bg-title2 border">
                        ...
                        <div class="content">
                            <h5 class="title"><a href="#">Rini</a></h5>
                ...
                <div class="item col-md-4 col-xs-6 pad-0_40">
                    <div class="bond-iconbox square outtop bg-title2 border">
                        ...
                        <div class="content">
                            <h5 class="title"><a href="#">Gjini</a></h5>
                ...
                <div class="item col-md-4 col-xs-6 pad-0_40">
                    <div class="bond-iconbox square outtop bg-title2 border">
                        ...
                        <div class="content">
                            <h5 class="title"><a href="#">Edukim</a></h5>
                ...
                <div class="item col-md-4 col-xs-6 pad-0_40">
                    <div class="bond-iconbox square outtop bg-title2 border">
                        ...
                        <div class="content">
                            <h5 class="title"><a href="#">Kulturë</a></h5>
    ...
    <section class="bond-row padb-49">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="title-section style1">
                    ...
                    <div class="desc">
                        <p>Forumet, ngjarjet dhe më shumë</p>
                    </div>
                </div><!-- /.title-section style1 -->
            </div><!-- /.col-md-12 -->
        </div>
        <div class="container">
            <div class="row">
                ...
                <a class="box-readmore center-rx" href="/gallery">Shiqoni më shumë</a>
    ...
    <section class="bond-row padb-110  bg-f5">
        ...
        <div class="container">
            <div class="title-section style1 row mgb-49">
                <h3 class="title">Deshmite</h3>
                <div class="desc">
                    <p>Ndani një moment për të lexuar disa nga dëshmitë tona në lidhje me ndërtimin e besimit!</p>
                </div>
            </div><!-- /.title-section style1 -->
                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="widget widget_text">
                            <p>  UNMIK-u përkrah financiarisht krijimin, lancimin dhe mirëmbajtjen e platformës deri në dorëzimin e saj.</p>
                        </div><!-- /.widget-text -->
                    </div><!-- /.col-md-4 -->
                    <div class="col-md-2">
                        <div class="widget widget_text">
                            <p>UNMIK-u jo domosdoshmërisht mbështet mendimet ose deklaratat e shprehura në platformë.
                            </p>
                        </div><!-- /.widget-text -->
                    </div><!-- /.col-md-4 -->
                    <div class="col-md-2">
                        <div class="widget widget_text">
                            <p>UNMIK-u jo domosdoshmërisht mbështet politikat dhe besimet e organizatave ose individëve të listuara ose të referuara.</p>
                        </div><!-- /.widget-text -->
                    </div><!-- /.col-md-4 -->
                    <div class="col-md-2">
                        <div class="widget widget_new_letter">
                            <p>Përdorimi i emrave gjeografikë dhe i kufijve nuk nënkupton gjykimin mbi statusin ligjor të Kosovës.</p>
                            <p>Përfshirja e një vegëze ose reference nuk nënkupton miratimin e asaj faqeje të internetit nga UNMIK-u.</p>                       
                        </div><!-- /.widget-new_letter -->
                    </div><!-- /.col-md-4 -->
                    <div class="col-md-2">
                        <div class="widget widget_new_letter">
                            <p>UNMIK-u nuk është përgjegjës për sjelljen e ndonjë përdoruesi.</p>
                        </div><!-- /.widget-new_letter -->
                    </div>
                    <div class="col-md-2">
                        <div class="widget widget_new_letter">
                            <p>Komunikimet e shtuara në forume nuk do të konsiderohen si të shqyrtuara ose të miratuara nga UNMIK-u.</p>
                        </div><!-- /.widget-new_letter -->
                    </div>
                </div><!-- /.row -->
            </div><!-- /.container -->
