...
<body class="header-sticky blog-details">  
                        ...
                        <div class="col-md-6 padding-left-45">                   
                            <div class="iconbox ">
                                <div class="box-header">
                                    <h2 class="box-title">UNDP</h2>
                                </div>
                                <div class="box-content">
                                    <p>
                                    UNDP works in about 170 countries and territories, helping to eradicate poverty, reduce inequalities and exclusion, and build resilience so countries can sustain progress. As the UN’s development agency, UNDP plays a critical role in helping countries achieve the Sustainable Development Goals. </p>
                                    <p>
                                    The Sustainable Development Goals (SDGs), otherwise known as the Global Goals, are a universal call to action to end poverty, protect the planet and ensure that all people enjoy peace and prosperity.
                                    UNDP publications showcase the organization’s thought leadership and expertise and play a key role in fulfilling our mandate to support the realisation of the SDGs and encourage global development. </p>                                
                                    
                                    <a class="box-readmore pad-0_43" href="https://www.undp.org/" target="_blank">VISIT SITE</a>
  ...
  <!-- Projects section - Bond parallax home1 -->
  <div class="box-header">
    <h2 class="box-title" style="margin-left: 200px">PROJECTS</h2>
 </div>
  <section class="bond-row pad-0">
            <div class="container">
                <div class="row">
                    ...
                    <div class="bond-portfolio three_columns">
