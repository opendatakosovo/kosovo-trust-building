            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="post-wrap">
                        ...
                        <article class="post clearfix cat-item-9">
                            <div class="featured-post">
                                <div class="entry-image">
                                    <img src="images/blog/v1/1.png" alt="image">
                                </div>
                            </div>
                            <div class="content-post">
                                <h4 class="title-post">
                                    <a href="newsarticle1.html">Nunc non metus sedosot justo semper pharet Curnon amesieros</a>
                                </h4>
                        ...
                        <article class="post clearfix">
                            <div class="featured-post">
                                <div class="entry-image">
                                    <img src="images/blog/v1/2.png" alt="image">
                                </div>
                            </div>
                            <div class="content-post">
                                <h4 class="title-post">
                                    <a href="newsarticle1.html">Aenean accumsan diam et mauris blan dit vehicula Pellentes</a>
                                </h4>
                                <div class="entry-meta"> 
                                    <div class="meta-1">                                    
                                        <span class="author"><i class="fa fa-user" aria-hidden="true"></i><a href="#">Juwel Khan</a></span>
                                        ...
                                        <span class="comment"><a href="#">53 comments</a></span>
                                    </div>
                                </div><!-- /.entry-meta -->
                        ...
                        <article class="post clearfix">
                            <div class="featured-post">
                                <div class="entry-image">
                                    <img src="images/blog/v1/3.png" alt="image">
                                </div>
                            </div>
                            <div class="content-post">
                                <h4 class="title-post">
                                    <a href="newsarticle1.html">Duis ullamcorper mi a turpis feugiat vel pulvinar mi condime</a>
                                </h4>
                                <div class="entry-meta">
                                    <div class="meta-1">                                    
                                        <span class="author"><i class="fa fa-user" aria-hidden="true"></i><a href="#">Juwel Khan</a></span>
